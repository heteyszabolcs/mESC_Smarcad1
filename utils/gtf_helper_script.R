gtf = fread("C:/Szabolcs/Karolinska/Data/reference_data/repeatmasker_mm10-ERVK.gtf")
...
gtf = write.table(mod, "C:/Szabolcs/Karolinska/Data/reference_data/repeatmasker_mm10-ERVK-int-gene_name_mod.gtf", col.names = FALSE, quote = FALSE, row.names = FALSE, sep = "\t")
